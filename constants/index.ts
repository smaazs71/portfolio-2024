...
export const journeyData = [
  ...
  },
  {
    ...
    description:
      "Developed a secure MERN Stack management system for AP Furniture, facilitating role-specific access and streamlined management of products, stocks, raw materials, and employees on a private Linux network.",
  },
  {
    title: "FREELANCING (NEXT JS)",
    Date: "Nov 2023 and Jan 2023",
    companyLogo: "/client/AP-furniture-logo-wobg.png",
    description:
      "Crafted a sleek Next.js and Tailwind CSS site for AP Furniture, spotlighting top-tier washing machine and fridge trolleys. Showcased product excellence as a digital showroom for potential clients and partners.",
  },
];
